...
/** Unit tests for main.java.com.example.functions.helloworld.AkamaiMetrics. */
@RunWith(JUnit4.class)
public class AkamaiMetricsTest {
  ...
  @Test
  public void AkamaiMetrics_shouldPrintFileName() throws InvalidProtocolBufferException {
    // Create event data
    String file = "foo.txt";
    ...
    new AkamaiMetrics().accept(event);
  ...
  @Test
  public void AkamaiMetrics_shouldPrintNotifyIfDataIsNull() throws InvalidProtocolBufferException {
    // Construct a CloudEvent
    CloudEvent event = CloudEventBuilder.v1()
        .withId("0")
        .withType("google.storage.object.finalize")
